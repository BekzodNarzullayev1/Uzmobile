...
import com.example.uzmobile.databinding.FragmentCategoryTimeBinding
...
class CategoryTimeFragment : Fragment() {
    ...
    lateinit var binding: FragmentCategoryTimeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCategoryTimeBinding.inflate(layoutInflater)
        ...
        firebaseFirestore.collection("packageTime")
            .get()
